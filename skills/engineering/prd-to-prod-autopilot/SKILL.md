...
- Every implementable issue is implemented through `implement`, verified with a `code-review` outcome, and reviewed/fixed, or explicitly blocked with evidence.
