...
- Refresh PR state, validate each Codex finding against the current head and supplied spec context, apply `THUMBS_UP` or `THUMBS_DOWN`, fix valid in-scope issues, run checks, commit, and push.
