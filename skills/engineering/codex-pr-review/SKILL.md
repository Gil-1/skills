...
- Treat Codex validation against the current `headRefOid` as the loop's success condition. Once confirmed, stop; do not request another review for cleaner wording or a second opinion.
