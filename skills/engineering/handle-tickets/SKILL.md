...
The conductor handoff must include status, ticket URL, worktree, branch, commits, changed files, checks, `code-review` report, fix result when needed, PR URL, Codex outcome, merge-ready yes/no, next action, and owner.
