...
I created these workflow skills to compose Matt Pocock's engineering skills into end-to-end automated runs that move from architecture or PRD intent to issues, implementation, verification, and PR review with minimal hand-holding.
...
`codex-pr-review` expects the GitHub CLI (`gh`) to be installed and authenticated in the target repository.
